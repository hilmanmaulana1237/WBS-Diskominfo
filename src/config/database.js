let users = [
    ...
    { id: 2, name: 'Budi Santoso', email: 'budi@email.com', password: '$2a$10$6nh.WvbGpIMJq5KILxfK.e2rHOIsNA8rZwSpAYP3qWXuQwGkGCxtS', role: 'user', is_active: 1, created_at: new Date() }
];
